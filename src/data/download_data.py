...
data_path = os.path.join(here, '..', '..', 'data', 'clean')
...
def download_reduced():
    if not os.path.isfile(os.path.join(data_path, 'organoid_reduced.csv')):
        pass
    
    if not os.path.isfile(os.path.join(data_path, 'primary_reduced.csv')):
        pass
